...
export type TaskSidebarGroupEditorState =
  | { mode: 'taskPath'; taskId: string; value: string }
  | { mode: 'renameGroup'; groupBlockId: string; value: string };

interface TaskSidebarGroupEditorProps {
  groupEditor: TaskSidebarGroupEditorState;
...
export function TaskSidebarGroupEditor({
  groupEditor,
  existingGroupPaths,
  isSaving,
  t,
        ...
        <div className="space-y-4 px-4 py-4 max-h-[400px] overflow-y-auto custom-scrollbar">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder={groupEditor.mode === 'taskPath' ? 'e.g. group1 / sub-group' : undefined}
              autoFocus
            />
            {groupEditor.mode === 'taskPath' && (
