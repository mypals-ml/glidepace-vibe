      ...
      <div className="flex items-center gap-2 md:gap-3">
        {(
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 rounded-lg bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors text-sm font-medium shadow-sm"
          ...
          >
            ...
            <span className="hidden sm:inline">{isChartVisible ? t('dashboard.listToggle') : t('dashboard.chartToggle')}</span>
          </button>
        )}
        ...
        >
          ...
          <span className="whitespace-nowrap truncate max-w-[120px] sm:max-w-[200px] lg:max-w-none">
