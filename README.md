...
This project is a website that provides a Gantt chart view for a GitHub.com repository's project.

## Features

*   **Connect to GitHub Projects:** Connects to your GitHub.com repository's project to visualize the project's tasks.
*   **Gantt Chart View:** Provides a Gantt chart view of the project, making it easy to see the project's timeline and dependencies.
